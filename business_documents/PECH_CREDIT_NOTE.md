...
<h1 style="margin:6px 0 0;font-size:1.7em;background:linear-gradient(90deg,#00BFFF,#F5A623);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">CREDIT NOTE</h1>
<p>
...
| Field | Details |
|---|---|
| Credit Note Number | __________________________________________ |
| Credit Note Date | __________________________________________ |
...
| Purchase Order Reference | __________________________________________ |
...
Please indicate the applicable reason for this credit note:

- [ ] **Overpayment** — Client made payment in excess of the invoiced amount
- [ ] **Returned Goods** — Goods returned by the client in accordance with the return policy
- [ ] **Price Adjustment** — Revision of unit price or agreed discount applied retrospectively
- [ ] **Defective / Damaged Goods** — Goods delivered were found to be defective or damaged
- [ ] **Service Not Rendered** — Billed service was not delivered or was partially delivered
- [ ] **Billing Error** — Incorrect amount, quantity, or item was invoiced
...
| S/N | Description | Qty | Unit Price (NGN) | Credit Amount (NGN) |
|---|---|---|---|---|
| 1 | | | | |
| 2 | | | | |
| 3 | | | | |
...
| | Amount (NGN) |
|---|---|
| **Subtotal Credit** | __________________________________________ |
| **VAT Adjustment (7.5%)** | __________________________________________ |
| **TOTAL CREDIT AMOUNT** | __________________________________________ |
...
- [ ] Credit applied to client account for future invoices
- [ ] Refund to client via bank transfer
- [ ] Refund to client via cheque
- [ ] Offset against outstanding invoice(s): __________________________________________
...
- [ ] Goods return note attached
- [ ] Client correspondence / complaint letter attached
- [ ] Delivery note / proof of delivery attached
- [ ] Other: __________________________________________
...
By signing below, the client acknowledges receipt of this credit note and the terms of settlement described herein.
...
1. This credit note is issued in reference to the original invoice stated above and must be read in conjunction with the original transaction documentation.
2. The credit amount shall be applied in accordance with the settlement method indicated herein.
3. This credit note shall be treated as a VAT adjustment document in accordance with the Value Added Tax Act and FIRS regulations.
4. PECH Group Holdings Ltd reserves the right to verify all claims before processing the credit.
5. This credit note is valid for a period of twelve (12) months from the date of issue. Any unclaimed credit after this period may be forfeited.
6. All disputes arising from this credit note shall be governed by the laws of the Federal Republic of Nigeria and shall be resolved through arbitration in Lagos, Nigeria.
...
*This credit note is issued by PECH Group Holdings Ltd, Lagos, Nigeria. Please retain for your records and VAT adjustment purposes.*
