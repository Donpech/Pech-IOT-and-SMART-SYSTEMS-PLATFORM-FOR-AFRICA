...
<h1 style="margin:6px 0 0;font-size:1.7em;background:linear-gradient(90deg,#00BFFF,#F5A623);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">PAYMENT VOUCHER</h1>
<p>
...
| Field | Details |
|---|---|
| Voucher Number | __________________________________________ |
| Voucher Date | __________________________________________ |
...
| Field | Details |
|---|---|
| Payee Name | __________________________________________ |
...
| TIN (if applicable) | __________________________________________ |
...
| S/N | Description of Payment | Account Code / GL Code | Amount (NGN) |
|---|---|---|---|
| 1 | | | |
| 2 | | | |
| 3 | | | |
...
| | Amount (NGN) |
|---|---|
| **Gross Amount** | __________________________________________ |
| **Less: WHT (Withholding Tax)** | __________________________________________ |
| **Less: VAT (if applicable)** | __________________________________________ |
| **Less: Other Deductions** | __________________________________________ |
| **NET AMOUNT PAYABLE** | __________________________________________ |
...
| Field | Details |
|---|---|
| Cheque Number | __________________________________________ |
| Cheque Date | __________________________________________ |
| Issuing Bank | __________________________________________ |
| Cheque Amount (NGN) | __________________________________________ |

### Bank Transfer Details (if applicable)

| Field | Details |
|---|---|
| Transfer Reference | __________________________________________ |
| Transfer Date | __________________________________________ |
| Paying Bank | __________________________________________ |
...
- [ ] Delivery Note / Goods Received Note attached
- [ ] Contract / Agreement reference attached
- [ ] Expense Report attached
- [ ] Board / Management approval attached
- [ ] Other: __________________________________________
...
| Date | __________________________________________ |
| Designation | __________________________________________ |
| ID Type & Number | __________________________________________ |

---

## TERMS AND CONDITIONS

1. This payment voucher must be duly completed and authorized before any payment is processed.
2. All payments exceeding the sum of Five Hundred Thousand Naira (NGN 500,000.00) require the joint authorization of at least two (2) designated signatories.
3. Supporting documentation must be attached to this voucher prior to submission for approval. Payment vouchers without adequate supporting documents shall be returned.
4. Withholding Tax (WHT) shall be deducted at source in accordance with the provisions of the Companies Income Tax Act (CITA) and the Personal Income Tax Act (PITA) as applicable, and remitted to the Federal Inland Revenue Service (FIRS) or the relevant State Internal Revenue Service.
5. The payee is responsible for providing accurate bank details. PECH Group Holdings Ltd shall not be liable for payments made to incorrect accounts due to erroneous information provided by the payee.
6. This voucher is an internal financial control document of PECH Group Holdings Ltd and shall be retained for audit purposes in accordance with the Companies and Allied Matters Act (CAMA) 2020.
7. Any alteration to this voucher must be initialed by the authorized signatory. Vouchers with unauthorized alterations shall be void.

---

*This payment voucher is an internal document of PECH Group Holdings Ltd, Lagos, Nigeria. For authorized use only.*
