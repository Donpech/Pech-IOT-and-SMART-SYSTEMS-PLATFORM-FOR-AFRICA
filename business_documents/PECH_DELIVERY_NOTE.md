...
| Field | Details |
|---|---|
| **Delivery Note No.:** | DN-________-________ |
...
| **Quotation Reference:** | QTN-________-________ |
...
| Field | Details |
|---|---|
| **Client/Company Name:** | __________________________________________ |
...
| Item No. | Description | Qty | Unit | Serial/Batch No. | Remarks |
|---|---|---|---|---|---|
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
...
**Total Number of Packages/Cartons:** __________________________________________
...
| **Driver's Phone:** | __________________________________________ |
| **Transport Company (if third-party):** | __________________________________________ |

---

## DISPATCH CONFIRMATION

I confirm that the goods listed above have been checked, packed, and dispatched in good condition.

| Role | Name | Signature | Date |
|---|---|---|---|
| **Packed/Checked By:** | __________________ | __________________ | ____/____/________ |
| **Dispatched By (Store/Warehouse):** | __________________ | __________________ | ____/____/________ |
| **Driver/Courier:** | __________________ | __________________ | ____/____/________ |
...
## DELIVERY CONFIRMATION (TO BE COMPLETED BY RECIPIENT)

I confirm receipt of the goods listed above.
...
- [ ] Damaged — (provide details below)
- [ ] Incomplete — (provide details below)
...
> **NOTE:** The recipient must inspect all goods at the time of delivery and note any discrepancies or damage on this Delivery Note before signing. PECH Group Holdings Ltd will not accept claims for damage or shortage reported after signing unless prior written agreement exists.
