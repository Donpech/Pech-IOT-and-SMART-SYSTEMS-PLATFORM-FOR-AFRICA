...
<h1 style="margin:6px 0 0;font-size:1.7em;background:linear-gradient(90deg,#00BFFF,#F5A623);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">CANDIDATE APPLICATION FORM</h1>
<p>
...
| Field | Details |
|---|---|
| **Surname / Last Name:** | __________________________________________ |
...
| Field | Details |
|---|---|
| **Phone Number (Primary):** | __________________________________________ |
| **Phone Number (Secondary):** | __________________________________________ |
| **WhatsApp Number:** | __________________________________________ |
...
> **Note:** Please attach a recent passport-sized photograph (white background, taken within the last 6 months).
...
*(List all qualifications starting from the most recent)*

### Tertiary / Higher Education

| # | Institution | Qualification (B.Sc., M.Sc., HND, etc.) | Course of Study | Year Graduated | Grade / Class |
|---|---|---|---|---|---|
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
...
| Institution | Location | Year Completed | Certificate (WAEC/NECO/GCE) | Result Summary |
|---|---|---|---|---|
| | | | | |

### Primary Education

| Institution | Location | Year Completed |
|---|---|---|
| | | |

### Professional Certifications

| # | Certification Name | Issuing Body | Year Obtained | Certificate No. | Expiry Date |
|---|---|---|---|---|---|
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
...
| # | Professional Body | Membership Type | Member Since |
|---|---|---|---|
| 1 | | | |
| 2 | | | |
...
*(List your last three (3) positions starting from the most recent. If you have no prior work experience, write "N/A" and proceed to Section 5.)*
...
| **Supervisor's Email:** | __________________________________________ |
...
*(For technical roles — Engineers, Designers, Data Analysts. Non-technical applicants may skip to Section 5B.)*

### 5A: Technical Skills Matrix
...
| Field | URL |
|---|---|
| **Portfolio Website:** | __________________________________________ |
| **GitHub Profile:** | __________________________________________ |
| **LinkedIn Profile:** | __________________________________________ |
| **Behance / Dribbble (Design):** | __________________________________________ |
| **Other (specify):** | __________________________________________ |

### Notable Projects or Contributions

*(Describe 1–3 projects you are most proud of)*
...
| **Technologies Used:** | __________________________________________ |
...
*(Provide at least two (2) professional references. References should NOT be family members.)*
...
| **Email Address:** | __________________________________________ |
| **How Long Have You Known This Person?** | __________________________________________ |
...
*(PECH Group Holdings Ltd requires two (2) guarantors for all full-time and contract positions. Provide preliminary guarantor details below. Full Guarantor Forms will be completed separately upon receipt of an offer letter.)*
...
| **Organisation / Employer:** | __________________________________________ |
| **Residential Address:** | __________________________________________ |
| **Phone Number:** | __________________________________________ |
| **Email Address:** | __________________________________________ |
...
*(Please answer ALL questions honestly. False declarations may result in disqualification or termination of employment.)*
...
### Data Protection Consent (NDPA 2023)
...
> I, the undersigned, hereby declare that all information provided in this application form is true, complete, and accurate to the best of my knowledge. I understand that any false, misleading, or incomplete information may result in:
> - Disqualification from the recruitment process
> - Withdrawal of any offer of employment
> - Termination of employment if discovered after hiring (per Employment Contract Clause 18.3 — Gross Misconduct)
>
> I authorize PECH Group Holdings Ltd to verify any information provided in this form, including contacting my references, previous employers, educational institutions, and guarantors.

| Field | Details |
|---|---|
| **Applicant's Full Name (Print):** | __________________________________________ |
...
*(This section is to be completed by the HR Department. Do NOT fill in if you are the applicant.)*

| Field | Details |
|---|---|
| **Application Reference No.:** | CAF-________-________ |
...
*(HR Officer — write your initial assessment of the candidate after reviewing their application)*
...
| **Round 2 Interviewer(s):** | __________________________________________ |
| **Round 3 Date (if applicable):** | ______ / ______ / __________ at ______:______ |
| **Round 3 Interviewer(s):** | __________________________________________ |
...
> - PECH Group Holdings Ltd is an equal opportunity employer.
