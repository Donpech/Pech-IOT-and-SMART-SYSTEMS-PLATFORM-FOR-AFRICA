...
<h1 style="margin:6px 0 0;font-size:1.7em;background:linear-gradient(90deg,#00BFFF,#F5A623);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">WAYBILL</h1>
<p>
...
| Field | Details |
|---|---|
| **Waybill Number:** | WB-________-________ |
...
| Field | Details |
|---|---|
| **Vehicle Type:** | __________________________________________ |
...
| **Driver's Phone Number:** | __________________________________________ |
| **Driver's Licence Number:** | __________________________________________ |
| **Transport Company:** | __________________________________________ |
| **Estimated Transit Time:** | __________________________________________ |

---

## GOODS DESCRIPTION

| Item No. | Description | Qty | Weight (kg) | Dimensions (L x W x H) | Declared Value (₦) |
|---|---|---|---|---|---|
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
...
| | |
|---|---|
| **Total Number of Packages:** | __________________________________________ |
| **Total Weight (kg):** | __________________________________________ |
| **Total Declared Value (₦):** | __________________________________________ |
...
- [ ] Temperature sensitive — Maintain ________°C
- [ ] Hazardous material — Handle per safety guidelines
...
| **Coverage Amount (₦):** | __________________________________________ |
...
|---|---|---|---|---|
| **Dispatched By:** | __________________ | __________________ | ____/____/________ | ____:____ |
| **Driver (Collected By):** | __________________ | __________________ | ____/____/________ | ____:____ |

---

## DELIVERY CONFIRMATION

I confirm receipt of the goods described above in the condition noted below.
...
- [ ] Damaged — Details: __________________________________________
- [ ] Short — Details: __________________________________________

---

> **IMPORTANT:** This Waybill must accompany the goods at all times during transit. The driver must present this document at all checkpoints and upon delivery. The consignee must inspect goods before signing. Any discrepancies must be noted on this Waybill at the time of delivery.
