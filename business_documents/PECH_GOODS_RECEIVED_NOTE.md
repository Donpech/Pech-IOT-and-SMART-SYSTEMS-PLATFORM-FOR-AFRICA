...
<h1 style="margin:6px 0 0;font-size:1.7em;background:linear-gradient(90deg,#00BFFF,#F5A623);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">GOODS RECEIVED NOTE (GRN)</h1>
<p>
...
| Field | Details |
|---|---|
| **GRN Number:** | GRN-________-________ |
| **Date Received:** | ______ / ______ / __________ (DD/MM/YYYY) |
| **Time Received:** | ________ : ________ (HH:MM) |
| **Purchase Order Reference:** | PO-________-________ |
| **Delivery Note Reference:** | DN-________-________ |
| **Invoice Reference (if available):** | __________________________________________ |
...
| Field | Details |
|---|---|
| **Delivered By (Driver/Courier Name):** | __________________________________________ |
| **Vehicle Registration No.:** | __________________________________________ |
| **Delivery Company (if different from Supplier):** | __________________________________________ |
| **Number of Packages/Cartons:** | __________________________________________ |
...
| Item No. | Description | Qty Ordered | Qty Received | Qty Rejected | Unit | Remarks |
|---|---|---|---|---|---|---|
| 1 | | | | | | |
| 2 | | | | | | |
| 3 | | | | | | |
...
- [ ] **Good** — All items received in satisfactory condition
- [ ] **Damaged** — Some items received with visible damage (see remarks)
- [ ] **Incomplete** — Not all ordered items were delivered
- [ ] **Excess** — More items received than ordered
- [ ] **Wrong Items** — Items received do not match order

**Detailed Condition Remarks:**
...
*(Complete ONLY if there are discrepancies between ordered and received goods)*

| Discrepancy Type | Item No. | Description | Details |
|---|---|---|---|
| Short Delivery | | | |
| Over Delivery | | | |
| Damaged Goods | | | |
...
| Field | Details |
|---|---|
| **Warehouse/Store Location:** | __________________________________________ |
| **Bin/Shelf Number:** | __________________________________________ |
| **Stock Code (if applicable):** | __________________________________________ |
...
|---|---|---|---|
| **Received By (Stores Personnel):** | __________________ | __________________ | ____/____/________ |
| **Inspected By (Quality/Technical):** | __________________ | __________________ | ____/____/________ |
| **Warehouse/Store Manager:** | __________________ | __________________ | ____/____/________ |
| **Finance/Accounts (Noted):** | __________________ | __________________ | ____/____/________ |

---

> **INSTRUCTIONS:** This Goods Received Note must be completed at the time of delivery. One copy shall be retained by the Stores Department, one copy forwarded to the Finance/Accounts Department, and one copy filed with the Purchase Order. Any discrepancies must be reported to the Procurement Department within twenty-four (24) hours of receipt.
