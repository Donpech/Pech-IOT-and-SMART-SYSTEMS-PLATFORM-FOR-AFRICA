...
<h1 style="margin:6px 0 0;font-size:1.7em;background:linear-gradient(90deg,#00BFFF,#F5A623);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">ASSET REGISTER / TRACKING FORM</h1>
<p>
...
| Field | Details |
|---|---|
| **Asset Tag Number:** | PECH-AST-________-________ |
| **Date Acquired:** | ______ / ______ / __________ (DD/MM/YYYY) |
| **Asset Category:** | [ ] IT Equipment [ ] Furniture [ ] Vehicle [ ] Tool/Machinery [ ] Electronics [ ] Other: ________ |
...
| Field | Details |
|---|---|
| **Asset Description:** | __________________________________________ |
| **Make/Brand:** | __________________________________________ |
...
| **Supplier Contact:** | __________________________________________ |
| **Purchase Order Reference:** | PO-________-________ |
| **Invoice Reference:** | INV-________-________ |
| **Purchase Price (₦):** | __________________________________________ |
| **Current Estimated Value (₦):** | __________________________________________ |
...
| **Assigned To (Employee Name):** | __________________________________________ |
| **Employee ID:** | __________________________________________ |
| **Date Assigned:** | ______ / ______ / __________ (DD/MM/YYYY) |

**Current Condition:**
- [ ] **New** — Unused, in original packaging
- [ ] **Good** — Fully functional, normal wear
- [ ] **Fair** — Functional, visible wear or minor issues
- [ ] **Poor** — Partially functional, requires repair
...
| Date | Transferred From (Name/Dept) | Transferred To (Name/Dept) | Reason | Authorized By |
|---|---|---|---|---|
| | | | | |
| | | | | |
| | | | | |
...
| Date | Description of Maintenance/Repair | Cost (₦) | Performed By | Next Service Due |
|---|---|---|---|---|
| | | | | |
| | | | | |
| | | | | |
...
**Total Maintenance Cost to Date (₦):** __________________________________________

---

## DISPOSAL DETAILS

*(Complete when asset is disposed of)*

| Field | Details |
|---|---|
| **Disposal Date:** | ______ / ______ / __________ (DD/MM/YYYY) |
| **Disposal Method:** | [ ] Sold [ ] Donated [ ] Scrapped [ ] Returned to Supplier [ ] Other: ________ |
| **Disposal Reason:** | __________________________________________ |
| **Disposal Proceeds (₦):** | __________________________________________ |
| **Approved By:** | __________________________________________ |
| **Disposal Certificate/Receipt:** | [ ] Attached [ ] N/A |
...
|---|---|---|---|
| **Asset Custodian:** | __________________ | __________________ | ____/____/________ |
| **IT/Admin Officer:** | __________________ | __________________ | ____/____/________ |
| **Finance Department:** | __________________ | __________________ | ____/____/________ |

---

> **POLICY:** All company assets must be registered using this form within five (5) working days of acquisition. Annual physical verification of all assets is mandatory. Employees are responsible for the care and safekeeping of assets assigned to them. Unauthorized transfer, disposal, or personal use of company assets is strictly prohibited and may result in disciplinary action.
