...
<h1 style="margin:6px 0 0;font-size:1.7em;background:linear-gradient(90deg,#00BFFF,#F5A623);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">LEAVE REQUEST FORM</h1>
<p>
...
| **Date of Joining:** | ______ / ______ / __________ (DD/MM/YYYY) |
| **Phone (during leave):** | __________________________________________ |
...
*(Tick the applicable leave type)*

- [ ] **Annual Leave** — Paid annual vacation entitlement
- [ ] **Sick Leave** — Medical leave (medical certificate required for >2 days)
- [ ] **Compassionate Leave** — Bereavement or family emergency
- [ ] **Maternity Leave** — Female employees (12 weeks as per Nigerian Labour Act)
- [ ] **Paternity Leave** — Male employees (2 weeks)
- [ ] **Study/Examination Leave** — Approved educational programs
- [ ] **Unpaid Leave** — Leave without pay (requires MD approval)
...
| Field | Details |
|---|---|
| **Leave Start Date:** | ______ / ______ / __________ (DD/MM/YYYY) |
| **Leave End Date:** | ______ / ______ / __________ (DD/MM/YYYY) |
| **Number of Working Days Requested:** | __________________________________________ |
| **Resumption Date:** | ______ / ______ / __________ (DD/MM/YYYY) |
...
| Leave Type | Annual Entitlement | Used to Date | Current Balance | Days Requested |
|---|---|---|---|---|
| Annual Leave | | | | |
| Sick Leave | | | | |
| Compassionate Leave | | | | |
...
*(To be verified by HR Department)*
...
| **Location/Address During Leave:** | __________________________________________ |
...
## RELIEF / HANDOVER ARRANGEMENTS

| Field | Details |
|---|---|
| **Relief Officer Name:** | __________________________________________ |
| **Relief Officer Position:** | __________________________________________ |
| **Relief Officer Department:** | __________________________________________ |
| **Handover Notes Prepared:** | [ ] Yes [ ] No |
| **Pending Tasks Documented:** | [ ] Yes [ ] No |
...
- [ ] Death Certificate / Obituary (for Compassionate Leave)
- [ ] Examination Timetable (for Study Leave)
- [ ] Other: __________________________________________
...
| Level | Name | Signature | Date | Approved / Denied |
|---|---|---|---|---|
| **Employee (Applicant):** | __________________ | __________________ | ____/____/________ | N/A |
| **Line Manager:** | __________________ | __________________ | ____/____/________ | [ ] Approved [ ] Denied |
| **HR Department:** | __________________ | __________________ | ____/____/________ | [ ] Approved [ ] Denied |
| **MD/CEO (if >5 days):** | __________________ | __________________ | ____/____/________ | [ ] Approved [ ] Denied |
...
> **POLICY NOTES:**
> - Leave requests must be submitted at least seven (7) working days in advance for planned leave.
> - Sick leave exceeding two (2) consecutive days requires a medical certificate from a registered medical practitioner.
> - Unpaid leave requests require approval from the Managing Director/CEO.
> - Leave may be denied or rescheduled based on operational requirements.
> - Employees must complete handover to their designated relief officer before proceeding on leave.
> - Failure to resume on the stated resumption date without prior approval may result in disciplinary action.
