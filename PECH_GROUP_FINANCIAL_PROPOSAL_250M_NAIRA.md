...
#### Phase 1 (Months 0–3): Foundation Team — 7 People
...
| 5 | **Compliance Advisor** (Part-time) | ₦200,000 | — | Avoid fatal regulatory mistakes |
| 6 | **Market Operations Manager** | ₦300,000 | — | Market politics + onboarding |
| 7 | **UI/UX Designer** (Contract) | ₦250,000 | — | All 5 platforms need design |

**Monthly payroll:** ₦2,400,000
**Quarterly payroll:** ₦7,200,000

#### Phase 2 (Months 4–6): Field Expansion — 12 People

| # | Role | Monthly Salary (₦) | Notes |
|---|------|-------------------|-------|
| 8 | **IoT/Embedded Engineer** | ₦400,000 | Firmware + device integration |
| 9 | **DevOps Engineer** | ₦350,000 | Cloud infrastructure + CI/CD |
| 10–12 | **Field Agents (3 contract)** | ₦80,000 each + per-merchant bonus | Merchant acquisition |

**Monthly payroll:** ₦3,990,000
**Quarterly payroll:** ₦11,970,000

#### Phase 3 (Months 7–9): Market Entry — 18 People

| # | Role | Monthly Salary (₦) | Notes |
|---|------|-------------------|-------|
| 13 | **Payments Product Manager** | ₦600,000 | Payment complexity management |
| 14 | **Data Analyst** | ₦350,000 | Credit scoring + insights |
| 15–17 | **Support Representatives (3)** | ₦150,000 each | Scale merchant support |
| 18 | **Additional Field Agents (5)** | ₦80,000 each | Expand to 2nd/3rd market |

**Monthly payroll:** ₦5,890,000
**Quarterly payroll:** ₦17,670,000

#### Phase 4 (Months 10–12): Revenue Scale — 25 People

| # | Role | Monthly Salary (₦) | Notes |
|---|------|-------------------|-------|
| 19 | **Risk & Fraud Analyst** | ₦400,000 | Regulator confidence |
| 20 | **Logistics Operations Lead** | ₦350,000 | Spoke-and-hub management |
| 21–23 | **Junior Engineers (3)** | ₦250,000 each | Scale development |
| 24–25 | **Additional Support (2)** | ₦150,000 each | Service quality |

**Monthly payroll:** ₦7,840,000
**Quarterly payroll:** ₦23,520,000

#### Phase 5 (Months 13–18): Ecosystem Maturity — 30-35 People

| # | Role | Monthly Salary (₦) | Notes |
|---|------|-------------------|-------|
| 26 | **Senior Data Engineer** | ₦500,000 | AI/ML pipeline |
| 27 | **Business Development Lead** | ₦400,000 | Enterprise + partnerships |
| 28 | **Content & Training Manager** | ₦250,000 | Installer certification |
| 29–30 | **Regional Field Coordinators (2)** | ₦200,000 each | Abuja + other cities |
| 31–35 | **Additional Field Agents (5)** | ₦80,000 each | National expansion |

**Monthly payroll:** ₦9,390,000
**Quarterly payroll (6 months):** ₦56,340,000

### 8.2 Total Human Capital Cost (18 Months)

| Phase | Duration | Avg Monthly (₦) | Total (₦) |
|-------|----------|-----------------|-----------|
| Phase 1 | 3 months | ₦2,400,000 | ₦7,200,000 |
| Phase 2 | 3 months | ₦3,990,000 | ₦11,970,000 |
| Phase 3 | 3 months | ₦5,890,000 | ₦17,670,000 |
| Phase 4 | 3 months | ₦7,840,000 | ₦23,520,000 |
| Phase 5 | 6 months | ₦9,390,000 | ₦56,340,000 |
| **TOTAL** | **18 months** | | **₦116,700,000** |

> **Note:** Actual budget is ₦82,000,000 for human capital. The difference is covered by:
> - Delayed hiring (some Phase 5 roles shift to Month 16-18)
...
|-----|--------|---------------|----------------|--------|
| SKU-1 | **Smart POS Terminal** (Android, 4G, printer built-in) | ₦45,000 | ₦65,000 | 44% |
| SKU-2 | **Business Tablet** (10", Android, LTE) | ₦35,000 | ₦55,000 | 57% |
| SKU-3 | **IoT Energy Controller** (ESP32, MQTT, solar) | ₦15,000 | ₦25,000 | 67% |
| SKU-4 | **Smart Meter** (energy monitoring) | ₦20,000 | ₦35,000 | 75% |
| SKU-5 | **Receipt + Barcode Kit** | ₦18,000 | ₦28,000 | 56% |
| SKU-6 | **Power Stability Kit** (Mini UPS + surge) | ₦12,000 | ₦20,000 | 67% |
| SKU-7 | **Logistics Scanner** (SUNMI-compatible) | ₦25,000 | ₦40,000 | 60% |
...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  PEOPLE (32.8%)           ₦82,000,000                          │
│  ├─ Engineering Team         ₦38,000,000                       │
│  ├─ Operations & Support     ₦22,000,000                       │
│  ├─ Field Agents             ₦12,000,000                       │
│  └─ Contractors & Advisors   ₦10,000,000                       │
│                                                                 │
│  HARDWARE (20.8%)         ₦52,000,000                          │
│  ├─ POS Terminals (600 units)  ₦27,000,000                    │
│  ├─ IoT Devices (350 units)    ₦12,250,000                    │
│  ├─ Accessories & Kits         ₦8,400,000                     │
│  └─ Shipping & Import Duty     ₦4,350,000                     │
│                                                                 │
